...
const Privacy = () => (
  <Layout>
    <div className="tabbed">
		...
		<ul className="tabs">
			<li className="tab"><label htmlFor="tab1">Gangsta lipsum</label></li>
			<li className="tab"><label htmlFor="tab2">Zombie lipsum</label></li>
			<li className="tab"><label htmlFor="tab3">New age bullshit</label></li>
		</ul>
		...
		<div className="tab-content">
			...
			<p>Generated by the New Age Bullshit Generator</p>
		</div>
</div>
  </Layout>
)
